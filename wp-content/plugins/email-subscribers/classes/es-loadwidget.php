...
class es_cls_widget
{
	public static function load_subscription($arr)
	{
		...
		$es .= '<p>
				...
				<span class="s-button"><input class="es_textbox_button" name="es_txt_button_pg" id="es_txt_button_pg" onClick="return es_submit_pages('.$url.')" value="订阅" type="button"></span>
