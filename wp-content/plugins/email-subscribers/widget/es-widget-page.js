function es_submit_pages(url)
{
	...
	var str= "es_email="+ encodeURI(es_email.value) + "&es_name=" + encodeURI('new user') + "&es_group=" + encodeURI(es_group.value) + "&timestamp=" + encodeURI(date_now) + "&action=" + encodeURI(mynumber);
